...
public class GameManager {
    ...
    public Result playRound(Move human_move) {
        ...
        if (human_move == bot_move)
            result = new Result(human, bot, human_move, bot_move, ResultType.Tie, roundNumber);
            ...
            result = new Result(human, bot, human_move, bot_move, ResultType.Win, roundNumber);
        } else {
            result = new Result(bot, human, human_move, bot_move, ResultType.Win, roundNumber);
        }
